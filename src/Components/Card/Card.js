    ...
    if (!(this.props.name === this.props.mainuser)) {
      fetch("https://agile-headland-13060.herokuapp.com/frndrqst", {
        ...
        .then((data) => {
          if (data) {
            alert(
              "friend rqst sent ! The user will appear in your contact list once he accept your friend request!!!"
            );
          }
        })
        .catch((err) => {
      ...
      <StyleRoot>
        <div style={styles.fadeIn}>
          {this.props.parameter === "friend" ? (
            <div
              className="dt w-100 bb b--black-05 pb2 mt2 pa2 bg-light-gray pointer"
            ...
            <div className="dt w-100 bb b--black-05 pb2 mt2 pa2 bg-lightest-blue">
              ...
              <div className="dtc v-mid pl3">
                <h1 className="f4 f3-ns fw6 lh-title black mv0">
                  {this.props.name}
                </h1>
              ...
              {this.props.parameter === "Confirm" ? (
                <div className="dtc tr v-mid pr3">
                  <button
                    className="f4 button-reset bg-dark-blue ba b--black-10 dim pointer br3 pa3 black-60"
                ...
                <div className="dtc tr v-mid pr3">
                  <button
                    className="f4 tr  button-reset bg-dark-green ba b--black-10 dim pointer pa3 br3 gold"
                    onClick={this.follow}
                    type="submit"
                    style={{ fontFamily: "Luckiest Guy" }}
                  >
