...
class Register extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      name: "",
      imageurl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRACqHZnYq7HfFp_OshaZ-Hgc_1mjYqJrWJpc71xNWcxdts2O0j6g",
    };
  }
      ...
      <StyleRoot>
        <div className="tc dt pv5 ph7" style={styles.zoomIn}>
          <div className="sans-serif dtc bg-transparent w-30 dib black relative cover bg-top">
            <div
              id="overlay"
              className="absolute ma1 absolute--fill bg-dark-gray o-90 z-unset  br4"
            ></div>

            <div className="relative pa4 pa5-m tc">
              <h1
                className="serif tracked ma0 mb4 b pa3 white br4 f1 tc bg-black"
              ...
              <p className="white ph3 f4" style={{ fontFamily: "Righteous" }}>
                Hola friend! This is a simple chat app which offers you realtime
                messaging with your friends. You can make friends by sending
                friend request to your known ones. Register for free and
                experience the Chatter app. You are free to provide your
                valuable suggestions and reviews in the dowm embeded link.
              </p>
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSctq5jRd2_uTTuH50QhYL3VSAbzvYF4dFjvYLYaVrQmboivKg/viewform?usp=sf_link">
                <img
                  className="ba dib b--black-10 v-mid mh2 br-100 pointer w1 w4-ns h1 h4-ns"
                  src={chico}
                  alt="Face"
                  width="500px"
                  height="auto"
          ...
          <div className="sans-serif dtc bg-transparent w-40 dib black relative cover bg-top">
            ...
            <div className="relative pa4 pa5-m">
              <h1
                className="serif tracked ma0 mb4 pv3 white br4 f1 tc bg-black"
                style={{ fontFamily: "Luckiest Guy" }}
              >
                Register
              </h1>
              ...
              <div>
                <div className="tc ma">
                  <img
                    className="ba b--black-10 br-100 w4 w4-ns h4 h4-ns"
                    id="inputimage"
                    alt="Face"
                ...
                <div className="v-mid">
                  <img
                    className="ba dib b--black-10 v-mid br-100 w1 w3-ns h1 h3-ns"
                    src={logo}
                    alt="Face"
                    width="500px"
                    height="auto"
                ...
                <div className="tc">
                  <input
                    className="input-reset tc white f6 b ttu mh2 w-70 pa3 pointer bg-black hover-bg-near-black bn br-pill"
                    value="Register"
                    onClick={this.onSubmitSignIn}
                    type="submit"
                  />
                  <p
                    className="serif tracked  pv1 f6 tc"
                  ...
                  <div className="tc">
                    <img
                      className="ba dib b--black-10 v-mid mh2 br-100 pointer w1 w2-ns h1 h2-ns"
                      title="In Beta Mode"
                      src={fb}
                      alt="Face"
                      width="500px"
